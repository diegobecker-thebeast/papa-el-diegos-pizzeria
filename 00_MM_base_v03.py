...
def not_blank(question):
    ...
    while True:
        ...
        if response == "":
            print("Sorry, this cant be left blank, try again.")
        else:
            return response
...
def calc_pizza_size(size_check):
    if size_check == "small":
        complete_size = 'S'
...
def calc_size_bonus(size_check):
    if size_check == "small":
        size_extra = 0
    elif size_check == "medium":
        size_extra = 1.5
...
while pizzas_sold < MAX_PIZZAS:
    ...
    print()
    print("You have selected a ${} {} pizza".format(price, pizza))
    ...
    size_scale = calc_pizza_size(size_check)
    extra = calc_size_bonus(size_check)

    print("You have selected a {} {} pizza".format(size_check, pizza))
    ...
    if topping_check == "yes":
        ...
        while extra_topping != "xxx":
            extra_topping = string_checker("What toppings do you want? (xxx to end): ", 7, topping_list)
            ...
            if extra_topping != "xxx":
                print("You have selected the {} topping".format(extra_topping))

    total_relay = extra + price
    print()
    print("Thanks for ordering with us {}, you're final pizza is:".format(name))
    print("A ${} size {} {} pizza including any toppings you selected".format(total_relay, size_scale, pizza))
